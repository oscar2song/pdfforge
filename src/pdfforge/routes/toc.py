...
def generate_toc():
    ...
    try:
        ...
        # Generate TOC
        result = get_toc_service().add_toc_to_file(temp_path, filename, bookmarks_data, toc_style_config)
...
def update_bookmarks():
    ...
    try:
        ...
        # Update bookmarks
        toc_service = get_toc_service()
        result = toc_service.update_pdf_bookmarks_in_file(input_file_path, pdf_file.filename, bookmarks_data)
...
def test_endpoint():
    ...
    return jsonify({"success": True, "message": "TOC routes are working!", "component": "toc", "test": True}), 200
